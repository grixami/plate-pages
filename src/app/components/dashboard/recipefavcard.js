...
export default function RecipeFavCard({ recipe, toggleFavorite }) {
    return (
        <div className="relative flex flex-col shadow-[0px_4px_6px_0px_rgba(0,_0,_0,_0.3)] bg-white rounded-lg h-[25vh]"> {/* Removed animation when hovered on so the star hover animation looks better */}
