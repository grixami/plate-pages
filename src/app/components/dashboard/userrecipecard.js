...
export default function UserRecipeCard({ recipe, callbackDelete }) {
    return (
        <div className="flex flex-col shadow-[0px_4px_6px_0px_rgba(0,_0,_0,_0.3)] bg-white rounded-lg transition-transform duration-300 hover:scale-105 hover:-translate-y-3">
