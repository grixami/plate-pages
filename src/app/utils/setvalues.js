// this is a list of all the constants on my programme, changing them here changes them everywhere, this file is made for ease of use

export const MaxPassLen = 40 // max length of a password
export const MinPassLen = 8 //TODO

export const MaxUsernameLen = 15 // max length of a username
export const MinUsernameLen = 3 //TODO
